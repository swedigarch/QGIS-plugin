SELECT o."ObjectId" as object_id, a."Label", av."Value", ad."Unit", ad."DataType", (o."ClassId" = am."ObjectDefId") as "Class", COALESCE(ft."AttributeId" > 0, false) as "LongText", ft."Text", am."AttributeOrder" FROM "Object" o
